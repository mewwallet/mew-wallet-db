...
public protocol MDBXObject {
  ...
  init(serializedData: Data, chain: MDBXChain, key: Data?, address: String?) throws
  init(jsonString: String, chain: MDBXChain, key: Data?, address: String?) throws
  init(jsonData: Data, chain: MDBXChain, key: Data?, address: String?) throws
