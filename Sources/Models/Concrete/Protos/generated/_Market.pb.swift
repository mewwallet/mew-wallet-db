...
struct _Market {
  ...
  fileprivate var _floor: _Floor? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

extension _Market: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "_Market"
  ...
  static func ==(lhs: _Market, rhs: _Market) -> Bool {
