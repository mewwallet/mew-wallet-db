...
struct _EnergyRewardReceipt {
  ...
  enum _PurchaseType: SwiftProtobuf.Enum {
  ...
  struct _Item {
    ...
    #if !swift(>=4.1)
      static func ==(lhs: _EnergyRewardReceipt._Item.OneOf_Payload, rhs: _EnergyRewardReceipt._Item.OneOf_Payload) -> Bool {
        ...
        case (.energy, .energy): return {
          guard case .energy(let l) = lhs, case .energy(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
    ...
    enum _ItemType: SwiftProtobuf.Enum {
      typealias RawValue = Int
      case unknown // = 0
      case icon // = 1
      case energy // = 2
    ...
    struct _NFT {
      ...
      enum _Rarity: SwiftProtobuf.Enum {
        typealias RawValue = Int
        case unknown // = 0
        case common // = 1
        case uncommon // = 2
    ...
    struct _ICON {
      ...
      enum _IconID: SwiftProtobuf.Enum {
        typealias RawValue = Int
        case iconUnknown // = 0
        case iconEnergy // = 1
        case UNRECOGNIZED(Int)
...
extension _EnergyRewardReceipt: @unchecked Sendable {}
extension _EnergyRewardReceipt._PurchaseType: @unchecked Sendable {}
extension _EnergyRewardReceipt._Item: @unchecked Sendable {}
extension _EnergyRewardReceipt._Item.OneOf_Payload: @unchecked Sendable {}
extension _EnergyRewardReceipt._Item._ItemType: @unchecked Sendable {}
extension _EnergyRewardReceipt._Item._NFT: @unchecked Sendable {}
extension _EnergyRewardReceipt._Item._NFT._Rarity: @unchecked Sendable {}
extension _EnergyRewardReceipt._Item._ICON: @unchecked Sendable {}
extension _EnergyRewardReceipt._Item._ICON._IconID: @unchecked Sendable {}
extension _EnergyRewardReceipt._Item._ENERGY: @unchecked Sendable {}
extension _EnergyRewardReceipt._Item._ENERGY._Size: @unchecked Sendable {}
