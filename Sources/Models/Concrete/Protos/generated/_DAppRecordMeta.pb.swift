...
struct _DAppRecordMeta: Sendable {
...
extension _DAppRecordMeta: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "_DAppRecordMeta"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}url\0\u{1}icon\0")
  ...
  static func ==(lhs: _DAppRecordMeta, rhs: _DAppRecordMeta) -> Bool {
