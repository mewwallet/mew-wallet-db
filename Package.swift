...
let package = Package(
  ...
  dependencies: [
    .package(name: "MEWextensions",
             url: "https://github.com/Foboz/MEWextensions.git",
             .exact("1.0.9")),
    
    .package(name: "mdbx-ios",
             url: "https://github.com/Foboz/mdbx-ios.git",
             .branch("feature/engine-update")),
  ...
  targets: [
    .target(name: "mew-wallet-db",
            dependencies: ["mdbx-ios", "MEWextensions", "SwiftProtobuf"],
            path: "Sources"),
