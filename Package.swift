...
let package = Package(
  ...
  dependencies: [
    .package(name: "mew-wallet-ios-extensions", url: "git@github.com:mewwallet/mew-wallet-ios-extensions.git", .upToNextMajor(from: "1.0.0")),
    .package(name: "mdbx-ios", url: "git@github.com:mewwallet/mdbx-ios.git", .exact("1.0.11")),
